...
//       $name=$_POST['name'];
//       $phone=$_POST['phone'];
//   $ins=$pdo->prepare("UPDATE aadmin SET qid=:qid,name=:name,phone=:phone WHERE qid=:id");
//       $ins->bindValue(':qid',$id);
...
<body>
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-1 pb-1 mb-1 border-bottom">
    <h5 class="h5">Department Heads</h5>
    <div class="btn-toolbar mb-2 mb-md-0">
      <div class="btn-group me-2">
        <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#invmodal"> Add Head</button>
      </div>
            ...
            <form class="was-validated" method="POST" id="addins" action="#"  enctype="multipart/form-data">
              ...
              <div class="col mb-1">
                  ...
                  <select id="depa" name="depa" class="form-select" required aria-label="taype">
                    <option value></option>
                    <?php foreach ($depart as $colfep) :  ?>
                      <option value="<?php echo $colfep['dep_id'] ?>"><?php echo $colfep['dep_name'] ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
                <div class="col mb-1">
...
var anchor = document.querySelector('a.nav-link.dephead');
if (anchor) {
...
$mail->Password = '@@Abrham08';
$mail->setFrom('abrhamgelawu@gmail.com', 'ag');
$mail->addAddress('projectge777@gmail.com', 'ss Name');
