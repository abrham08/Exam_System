...
$fetch = $pdo->prepare('SELECT * FROM account WHERE Department=:depa AND user_type=:teach ');
...
<body>
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-1 pb-1 mb-1 border-bottom">
    <h5 class="h5">Teacher's</h5>
    <div class="btn-toolbar mb-2 mb-md-0">
      <div class="btn-group me-2">
        <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#invmodal"> Add Teacher</button>
      </div>
        ...
        <tbody>
          ...
          ?>
            <tr class="">
              ...
              <td>
                <button type="button" title="Edit" class="border-0 rugant fa  fa-edit" value="<?php echo $ca['user_id']; ?>" style="color:skyblue;margin-right:3%;" data-bs-toggle="modal" data-bs-target="#staticBackdrop"></button>
              ...
              <button type="submit" title="Delete" id="user_delete" name="qdelete" value="<?php echo $ca['user_id'] ?>" class='border-0 fa fa-trash' style='color:red'></button>
                ...
                <button type="button" title="Resend Confirmation" id="send_again" class="border-0 rugant fa  fa-envelope" value="<?php echo $ca['user_id']; ?>" style="color:skyblue;margin-right:3%;"></button>
              </td>
            </tr>
          <?php endforeach;
          ?>
        ...
        <div class="modal-body">
          <div class="form signup">
            <form class="was-validated" method="POST" id="addins" action="#"  enctype="multipart/form-data">
              ...
              <input type="hidden" value="<?php echo $depart; ?>" id="depa" name="depa">
              <div class=" row ">
                <div class="col mb-1">
                  <label>Title</label>
                ...
                <div class="col mb-1">
                  ...
                  <input type="text" pattern="[A-Za-z]+" title="Please enter text only" id="fname" class="form-control" name="fname" required placeholder="First Name ">

                </div>
                <div class=" col mb-1">
                  <label>Middle Name</label>
                  <input type="text" pattern="[A-Za-z]+" title="Please enter text only" id="mname" class="form-control" name="mname" required placeholder="Middle Name ">

                </div>
                <div class=" col mb-1">
                  <label>Last Name</label>
                  <input type="text" pattern="[A-Za-z]+" title="Please enter text only" id="lname" class="form-control" name="lname" required placeholder="Last Name ">
                </div>
              </div>
              <div class="row">
                <div class="col mb-1">
  ...
  <script>
    ...
    var anchor = document.querySelector('a.nav-link.tichur');
    if (anchor) {
...
if (!pattern.test(fname) || !pattern.test(mname) || !pattern.test(lname)) {
  ...
  $('#addInsSuccess').html('<div class="alert alert-danger">Invalid input. Phone number should be number with 10 digits </div>');
    ...
    formData.append('page', 'addinstruct');
    formData.append('action', 'addinss');
    formData.append('depa', document.forms["addins"]["depa"].value);
    ...
    var button = document.getElementById("addinstructor");
...
formData.append('depa', document.forms["updins"]["depa"].value);
