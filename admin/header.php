...
if (isset($_SESSION['huid']) && isset($_SESSION['hdepid'])) {
  ...
  $fetch->bindValue(':depa', $_SESSION['huid']);
  $fetch->bindValue(':teach', 'Head');
  $fetch->execute();
  ...
  <button class="text-white navbar-toggler position-absolute d-md-none collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="dropdown px-5">
      <a href="#" class="d-flex align-items-center  text-white link-info text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="img/account/<?php echo $hprofile['photo'] ?>" alt="" width="40" height="42" class="rounded-circle me-2">
      ...
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column pp" >
          <li class="nav-item aa mb-2">
            ...
            <a class="nav-link homie active " 
              
            href="home"><span class="fa fa-home"></span> Home</a>
            </a>
          </li>

          <li class="nav-item mb-2">

        <button class="btn nav-link caticati btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" data-bs-target="#orders-collapsec" aria-expanded="false">
        <span class="fa fa-layer-group"></span> Course
        </button>
        <div class="collapse" id="orders-collapsec">
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-0 ">
          <li><a class="link-dark  nav-links d-inline-flex text-decoration-none rounded" href="addcourse" id="exam_b">ALL Category</a></li>
          <li>
            <a  class="link-dark nav-links d-inline-flex text-decoration-none rounded" href="#" data-bs-toggle="modal" data-bs-target="#addmodal">Add Category</a></li>
          <li><a href="#" class="link-dark nav-links d-inline-flex text-decoration-none rounded" data-bs-toggle="modal" data-bs-target="#catmodal">Assign Category</a></li>
          <li class="nav-item mb-2">
            <a class="link-dark  nav-links d-inline-flex text-decoration-none rounded" href="category"> Assign Teacher 
            </a>
          </li>
        </ul>
        </div>
          ...
          <li class="nav-item mb-2">
            <a class="nav-link tichur"  href="addinstruct"><span class="fa fa-chalkboard-user"></span> Teacher
            </a>
          </li>
          <li class="nav-item mb-2">
            <a class="nav-link resulti" href="eResult"><span class="fa fa-square-poll-horizontal"></span> Result</a>
            </a>
          </li>

          <li class="nav-item mb-2">
            <a class="nav-link actexam" href="actexam"><span class="fa fa-pen-to-square"></span> Exam</a>
            </a>
          </li>

          <li class="nav-item mb-2">
            <a class="nav-link serv" href="service"><span class="fa fa-cogs"></span> Services</a>
            </a>
          </li>
        </ul>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="schange_password" method="post" class="was-validated">
              <div id="response"></div>
              <input type="hidden" value="<?php echo $_SESSION['huid'] ?>" id="userid">
              <div class="mb-3">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="schange_password" action="#" method="post" class="was-validated" enctype="multipart/form-data">
              <div id="response"></div>
              <input type="hidden" value="<?php echo $_SESSION['huid'] ?>" name="userid" id="userid">
