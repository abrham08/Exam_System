...
if (isset($_SESSION['hruid'])) {
  ...
  $fetch->bindValue(':depa', $_SESSION['hruid']);
  $fetch->bindValue(':teach', 'HR');
  $fetch->execute();
      ...
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column pp" >
          <li class="nav-item aa mb-2">
            ...
            href="#"><span class="fa fa-home"></span> Dashboard</a>
            </a>
          </li>
        ...
        <span class="fa fa-layer-group"></span> Category
        </button>
        <div class="collapse" id="orders-collapsec">
        <ul class="btn-toggle-nav list-unstyled fw-normal pb-0 ">
          <li><a class="link-dark  nav-links d-inline-flex text-decoration-none rounded" href="HRCategory" id="exam_b">ALL Category</a></li>
          <li>
          ...
          <li class="nav-item mb-2">
            <a class="link-dark  nav-links d-inline-flex text-decoration-none rounded" href="#"> Assign Teacher 
            </a>
          </li>
        </ul>
        </div>
          ...
          <li class="nav-item mb-2">
            <a class="nav-link tichurs"  href="vcandidate"><span class="fa fa-chalkboard-user"></span> Candidate
            </a>
          </li>
          <li class="nav-item mb-2">
            <a class="nav-link stud" href="#"><span class="fa fa-square-poll-horizontal"></span> Screening</a>
            </a>
          </li>

          <li class="nav-item mb-2">
            <a class="nav-link actexam" href="#"><span class="fa fa-pen-to-square"></span> Result</a>
            </a>
          </li>

          <li class="nav-item mb-2">
            <a class="nav-link serv" href="#"><span class="fa fa-cogs"></span> Notice</a>
            </a>
          </li>
        </ul>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="schange_password" method="post" class="was-validated">
              <div id="response"></div>
              <input type="hidden" value="<?php echo $_SESSION['hruid'] ?>" id="userid">
              <div class="mb-3">
